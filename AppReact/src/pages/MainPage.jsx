...
// Coordenadas da entrada da escola
const ANCHOR_LAT = -22.9068;
const ANCHOR_LNG = -47.0616;

// Converte latitude e longitude para coordenadas no mapa 3D
...
// Controla a câmera seguindo o personagem
function CameraController({ targetPos, topView, mapCenter, mapSize }) {
  ...
  useFrame((state) => {
    if (controlsRef.current) {
      ...
      // Mantém o foco da câmera um pouco acima do personagem
...
// Mostra a posição do jogador na visão ampla
  ...
  useEffect(() => {
    ...
    const watchId = navigator.geolocation.watchPosition(
      (position) => {
        ...
        const new3DPos = latLngToVector3(
          latitude,
          longitude
        );
...
// Pré-Carrega o arquivo do mapa em segundo plano para não travar a navegação
